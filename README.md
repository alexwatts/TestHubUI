...
There is a Jenkins pipeline [Here](http://138.68.170.14:30000) for deploying the main branch to staging. It's the job named 'TestHub-pipeline'. Access with the below Credentials
