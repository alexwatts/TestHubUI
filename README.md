...
```
http://165.22.127.149:30001
```

There is a Jenkins pipeline [Here](http://165.22.127.149:30000) for deploying the main branch to staging. It's the job named 'TestHub-pipeline'. Access with the below Credentials
